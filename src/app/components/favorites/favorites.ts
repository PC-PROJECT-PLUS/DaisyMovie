...
export class Favorites implements OnInit {
  ...
  favoriteItems = signal<FavoriteItem[]>([
    ...
    { id: 108, title: 'Spirited Away', year: 2001, matchScore: '99% Match', genres: ['Anime', 'Fantasy'], synopsis: 'Una ragazzina di dieci anni si perde in un mondo governato da dèi, streghe e spiriti.', posterUrl: 'https://images.unsplash.com/photo-1601850494422-3fb19e130d55?w=500&q=80', accentColor: '#ec4899', duration: '2h 5m', isSeries: false },
