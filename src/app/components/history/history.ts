...
export class HistoryComponent implements OnInit {
  ...
  historyItems = signal<HistoryItem[]>([
    ...
    { id: 701, title: 'Stranger Things', year: 2016, matchScore: '99% Match', genres: ['Sci-Fi', 'Thriller'], synopsis: 'Quando un ragazzino scompare, i suoi amici e la famiglia si trovano a scoprire forze occulte.', posterUrl: 'https://image.tmdb.org/t/p/w500/49WJfeN0moxb9IPfGn8b2AOjG09.jpg', accentColor: '#ef4444', duration: '4 Seasons', isSeries: true },
    { id: 702, title: 'Oppenheimer', year: 2023, matchScore: '98% Match', genres: ['Biography', 'Drama'], synopsis: 'La storia del fisico J. Robert Oppenheimer e la creazione della bomba atomica.', posterUrl: 'https://image.tmdb.org/t/p/w500/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg', accentColor: '#f59e0b', duration: '3h 0m', isSeries: false },
    ...
    { id: 608, title: 'Succession', year: 2018, matchScore: '94% Match', genres: ['Drama'], synopsis: 'La famiglia Roy controlla la più grande azienda di media e intrattenimento del mondo...', posterUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=500&q=80', accentColor: '#d4af37', duration: '4 Seasons', isSeries: true },
    ...
    { id: 102, title: 'The Matrix', year: 1999, matchScore: '98% Match', genres: ['Sci-Fi', 'Action'], synopsis: 'Un hacker scopre la vera natura della sua realtà.', posterUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=500&q=80', accentColor: '#10b981', duration: '2h 16m', isSeries: false },
  ...
  removeHistory(item: HistoryItem, event?: Event) {
    ...
    this.historyItems.update(items => items.filter(i => i.id !== item.id));
  }
